...
document.querySelector('#clipboard').onclick = async () => {
    try {
        await navigator.clipboard.writeText('Nathaly Yohio Ortiz Red Mujer Mi Aliada Banco Económico S.A • Work cell: +591 67707842 • work phone: +591 3 3155864 • Personal cell: +591 75597888 • nyovhio@baneco.com.bo • nathalyyovhio@gmail.com • Calle Ayacucho #166 Santa Cruz, Bolivia 🇧🇴');
        //console.log('copiado');
